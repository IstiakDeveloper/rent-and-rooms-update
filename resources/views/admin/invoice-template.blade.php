...
<body>
    <div class="invoice-box">
        ...
        <div class="booking-info">
            ...
            <strong>Package:</strong> {{ $booking->package->name ?? 'N/A' }}<br>
            <strong>Duration:</strong> {{ $booking->number_of_days ?? 'N/A' }} days ({{ \Carbon\Carbon::parse($booking->from_date)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($booking->to_date)->format('d/m/Y') }})
        </div>
