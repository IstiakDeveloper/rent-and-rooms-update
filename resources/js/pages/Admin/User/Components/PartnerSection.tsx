...
function PartnerPersonalDocuments({ userId, partnerDocuments }: { userId: number, partnerDocuments?: PartnerDocument | null }) {
    ...
    const handleUpload = (field: string, file: File, expiryDate: string) => {
        ...
        router.post(`/admin/users/${userId}/partner-documents`, formData, {
            onSuccess: () => {
    ...
    const handleDelete = (field: string) => {
        if (confirm('Are you sure you want to delete this document?')) {
            router.delete(`/admin/users/${userId}/partner-documents/${field}`);
        }
    };

    const handleDownload = (field: string) => {
        window.location.href = `/admin/users/${userId}/partner-documents/${field}/download`;
    };
...
export default function PartnerSection({
    ...
    const handleAddDocument = () => {
        ...
        router.post(`/admin/users/${userId}/document-items`, form, {
            onSuccess: () => {
    ...
    const handleUpdateDocument = (docId: number) => {
        ...
        router.post(`/admin/users/${userId}/document-items/${docId}`, form, {
            onSuccess: () => {
                setEditingDoc(null);
                resetDocForm();
            },
    ...
    const handleDeleteDocument = (docId: number) => {
        if (confirm('Are you sure you want to delete this document?')) {
            router.delete(`/admin/users/${userId}/document-items/${docId}`);
        }
    };

    const handleDownloadDocument = (docId: number) => {
        window.location.href = `/admin/users/${userId}/document-items/${docId}/download`;
    };
