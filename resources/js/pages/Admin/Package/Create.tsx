...
export default function Create({ countries, cities: allCities, areas: allAreas, properties, maintains, amenities, documentError }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        freeAmenities: [] as number[],
        paidMaintains: [] as PaidService[],
        paidAmenities: [] as PaidService[],
        instructions: [{ title: '', description: '', order: 0 }] as Instruction[],
        photos: [] as File[],
    });
    ...
    useEffect(() => {
        if (data.country_id) {
            ...
            setData(prev => ({ ...prev, city_id: '', area_id: '' }));
        } else {
            setCities([]);
        }
    }, [data.country_id]);
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Fill in the details to create a new package</p>
                    </div>
                    <button
                        type="button"
