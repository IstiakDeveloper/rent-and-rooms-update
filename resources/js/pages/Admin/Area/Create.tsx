...
export default function Create({ countries, cities: initialCities, defaultCountryId }: Props) {
    const [formData, setFormData] = useState({
        country_id: defaultCountryId?.toString() || '',
        city_id: '',
        name: '',
        ...
        <AdminLayout>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-lg shadow p-6 max-w-2xl">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Create Area</h1>
