...
export default function Edit({ area, countries, cities: initialCities }: Props) {
    const [formData, setFormData] = useState({
        country_id: area.country_id.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(`/admin/areas/${area.id}`, data, {
            onError: (err) => {
                setErrors(err);
                setProcessing(false);
            },
    ...
    return (
        <AdminLayout>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-6">
                    <a href="/admin/areas" className="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                ...
                <div className="bg-white rounded-lg shadow p-6 max-w-2xl">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Area</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            {area.photo && (
                                <div className="mb-2">
                                    <img src={`/storage/${area.photo}`} alt={area.name} className="w-32 h-32 object-cover rounded" />
                                </div>
                            )}
                            <input
                                type="file"
